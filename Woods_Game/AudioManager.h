...
private:
	...
	std::map<std::pair<std::string, std::string>, ALLEGRO_SAMPLE_INSTANCE *> sample_instance_map;
	
	ALLEGRO_SAMPLE_INSTANCE * get_sample_instance(const std::string filename, const int audio_type);
	ALLEGRO_SAMPLE_INSTANCE * get_sample_instance(const std::string filename, const int audio_type, const std::string sound_key);
	...
	void play_audio(const std::string filename, const int audio_type, const std::string sound_key, const float gain, const float pan);
...
public:
	...
	void play_sfx(const std::string filename, const std::string sound_key, const float gain, const float pan);
