...
public:
	ImageFilter();
	~ImageFilter();
	void draw(ALLEGRO_DISPLAY*, ALLEGRO_BITMAP * target_bitmap, ALLEGRO_BITMAP * filter_bitmap, GlobalTime*, const int, const int, const int screen_w, const int screen_h);
	void toggle();
